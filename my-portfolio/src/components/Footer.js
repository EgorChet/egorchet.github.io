  ...
  return (
    <footer className='footer--container'>
      <div className='footer--link--container'>
        <div>
          <img src='./logos/logotype.webp' alt='Logoipsum' width='100' />
        </div>
        ...
        <div className='footer--social--icon'>
          <ul>
            <li>
              <a
                href='https://github.com/egorchet'
                className='navbar--content'
                target='_blank'
                rel='noreferrer'
              >
            ...
            <li>
              <a
                href='https://www.facebook.com/egorchetverikov'
                className='navbar--content'
                target='_blank'
                rel='noreferrer'
              >
            ...
            <li>
              <a
                href='https://www.instagram.com/egorchetverikov'
                className='navbar--content'
                target='_blank'
                rel='noreferrer'
              >
            ...
            <li>
              <a
                href='https://www.linkedin.com/in/egorchet'
                className='navbar--content'
                target='_blank'
                rel='noreferrer'
              >
      ...
      <div className='footer--content--container'>
        <p className='footer--content'>Created By Egor Chetverikov</p>
        <div className='footer--social--icon'>
          <ul>
            <li>
              <Link
